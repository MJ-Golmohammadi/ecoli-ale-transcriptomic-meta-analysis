...
"menF KO, rep 1",
"menF KO, rep 2",
"menF KO adapted 1, rep 1",
"menF KO adapted 1, rep 2",
"menF KO adapted 2, rep 1",
"menF KO adapted 2, rep 2",
"menF KO adapted 3, rep 1",
"menF KO adapted 3, rep 2",
"menF KO adapted 4, rep 1",
"menF KO adapted 4, rep 2"
)]
...
vst_long$Condition <- ifelse(
  grepl("^menF KO, rep", vst_long$Sample),
  "KO",
  "ALE"
)
...
p_box <- ggplot(
  ...
  labs(
    title = "VST-normalized expression distribution-menF(GSE224889)",
...
ggsave(
  "figures/GSE224889/VST_boxplot_GSE224889-menF.png",
  plot = p_box,
  width = 7,
  height = 5,
  dpi = 600
...
ggsave(
  "figures/GSE224889/VST_boxplot_GSE224889-menF.pdf",
  plot = p_box,
  width = 7,
  height = 5
)
...
write.csv(assay(vsd), "results/GSE224889/VST_expression-menF.csv")

p <- plotPCA(vsd, intgroup = "condition") +
  ggtitle("PCA of VST-normalized counts-menF (GSE224889)") +
  theme(
...
ggsave(
  "figures/GSE224889/PCA_plot_GSE224889-menF.png",
  width = 8,
  height = 6,
  dpi = 600
)
...
ggsave(
  "figures/GSE224889/PCA_plot_GSE224889-menF.pdf",
  width = 8,
  height = 6
)
...
pheatmap(
  ...
  main = "Sample-to-Sample Distance after VST normalization - menF (GSE224889)",
  filename = "figures/GSE224889/Sample_distance_heatmap_GSE224889-menF.pdf",
  width = 6,
  height = 5,
  fontsize = 7,
  fontsize_row = 6,
...
pheatmap(
  ...
  annotation_names_col = TRUE,
  main = "Sample-to-Sample Distance after VST normalization - menF (GSE224889)",
  filename = "figures/GSE224889/Sample_distance_heatmap_GSE224889-menF.png",
  width = 6,
  height = 5,
  fontsize = 7,
  fontsize_row = 6,
...
write.csv(
  deg,
  "results/GSE224889/GSE224889_DEGs-menF.csv",
  row.names = FALSE
)
...
write.csv(
  meta_deg,
  "results/GSE224889/GSE224889_meta_input-menF.csv",
  row.names = FALSE
)
...
write.csv(
  deg_sig,
  "results/GSE224889/GSE224889_significant-menF.csv",
  row.names = FALSE
)
#################################################
# Summary statistics
...
write.csv(
  up_genes,
  "results/GSE224889/GSE224889_upregulated-menF.csv",
  row.names = FALSE
)
...
write.csv(
  down_genes,
  "results/GSE224889/GSE224889_downregulated-menF.csv",
  row.names = FALSE
)
...
(
  EnhancedVolcano(
    ...
    title = 'menF KO  adapted vs menF KO (GSE224889)',
    subtitle = '',
    pCutoff = 0.05,
    FCcutoff = 1,
    pointSize = 2.5,
...
ggsave(
  "figures/GSE224889/Volcano_plot_shrink_GSE224889-menF.png",
  width = 9.5,
  height = 9.5,
  dpi = 600
)
...
ggsave(
  "figures/GSE224889/Volcano_plot_shrink_GSE224889-menF.pdf",
  width = 9.5,
  height = 9.5
)
...
ggsave(
  "figures/GSE224889/MA_plot_GSE224889-menF.png",
  plot = p_ma,
  width = 8,
  height = 6,
  dpi = 600
...
ggsave(
  "figures/GSE224889/MA_plot_GSE224889-menF.pdf",
  plot = p_ma,
  width = 8,
  height = 6
)
