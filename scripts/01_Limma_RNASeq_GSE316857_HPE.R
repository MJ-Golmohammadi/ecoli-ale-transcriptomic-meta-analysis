...
counts <- as.data.frame(
  read_excel(
    "data/GSE316857/GSE316857_Paraquat_evolved_tpm.xlsx",
    col_names = FALSE
  )
)
dim(counts)
...
new_names <- c(
  "Gene ID",
  as.character(unlist(counts[2, -1]))
)
...
sapply(counts, class)
#################################################
# Select samples for GSE316857 ALE analysis
#################################################
samples <- c(
  "ARG-RS_88",
  "ARG-RS_89",
...
expr_long$Expression_plot <- log2(
  expr_long$Expression + 1
)
...
p_box <- ggplot(
  ...
  labs(
    title = "TPM expression distribution (HPE vs WT, GSE316857)",
    subtitle = "log2(TPM + 1)",
    x = NULL,
    y = "log2(TPM + 1)"
  ) +
...
ggsave(
  "figures/GSE316857/Expression_boxplot_GSE316857_HPE.png",
  plot = p_box,
  width = 7,
  height = 5,
  dpi = 600
...
ggsave(
  "figures/GSE316857/Expression_boxplot_GSE316857_HPE.pdf",
  plot = p_box,
  width = 7,
  height = 5
)
...
p <- ggplot(
  ...
  labs(
    title = "PCA of log2(TPM + 1) expression values (HPE vs WT, GSE316857)",
    x = paste0(
      "PC1 (",
...
ggsave(
  "figures/GSE316857/PCA_plot_GSE316857_HPE.png",
  plot = p,
  width = 8,
  height = 6,
  dpi = 600
...
ggsave(
  "figures/GSE316857/PCA_plot_GSE316857_HPE.pdf",
  plot = p,
  width = 8,
  height = 6
)
...
pheatmap(
  ...
  main = "Sample-to-Sample Distance of log2(TPM + 1) expression values (HPE vs WT, GSE316857)",
  filename = "figures/GSE316857/Sample_distance_heatmap_GSE316857_HPE.pdf",
  width = 6,
  height = 5,
  fontsize = 7,
  fontsize_row = 6,
...
pheatmap(
  ...
  annotation_names_col = TRUE,
  main = "Sample-to-Sample Distance of log2(TPM + 1) expression values (HPE vs WT, GSE316857)",
  filename = "figures/GSE316857/Sample_distance_heatmap_GSE316857_HPE.png",
  width = 6,
  height = 5,
  fontsize = 7,
  fontsize_row = 6,
...
write.csv(
  deg,
  "results/GSE316857/GSE316857_DEGs_HPE.csv",
  row.names = FALSE
)
...
write.csv(
  meta_deg,
  "results/GSE316857/GSE316857_meta_input_HPE.csv",
  row.names = FALSE
)
...
write.csv(
  deg_sig,
  "results/GSE316857/GSE316857_significantHPE.csv",
  row.names = FALSE
)
...
write.csv(
  up_genes,
  "results/GSE316857/GSE316857_upregulated_HPE.csv",
  row.names = FALSE
)
...
write.csv(
  down_genes,
  "results/GSE316857/GSE316857_downregulated_HPE.csv",
  row.names = FALSE
)
...
write.csv(
  meta_deg,
  "results/GSE316857/GSE316857_SignedZ_HPE.csv",
  row.names = FALSE
)
...
ggsave(
  "figures/GSE316857/Volcano_plot_GSE316857_HPE.png",
  width = 9.5,
  height = 9.5,
  dpi = 600
)
...
ggsave(
  "figures/GSE316857/Volcano_plot_GSE316857_HPE.pdf",
  width = 9.5,
  height = 9.5
)
...
p_ma <- ggplot(
  ...
  labs(
    title = "MA Plot: HPE vs WT (GSE316857)",
    subtitle = "",
    x = "Average log2(TPM + 1)",
...
ggsave(
  "figures/GSE316857/MA_plot_GSE316857_HPE.png",
  plot = p_ma,
  width = 8,
  height = 6,
  dpi = 600
...
ggsave(
  "figures/GSE316857/MA_plot_GSE316857_HPE.pdf",
  plot = p_ma,
  width = 8,
  height = 6
)
